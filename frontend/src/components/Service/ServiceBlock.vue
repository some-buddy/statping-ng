<template>
    <div class="mb-md-4 mb-4">
        <div class="card index-chart" :class="{'expanded-service': expanded}">
            ...
            <div class="row lower_canvas full-col-12" :class="serviceBadgeClass(service)">
                ...
                <div class="col-md-2 col-6 float-right">
                    <button v-if="!expanded" @click="setService" class="btn btn-sm float-right dyn-dark" :class="serviceBadgeClass(service)">
                        {{$t('view')}}
                    </button>
                </div>
            </div>
